...
{{-- <div x-show="createModalOpen" x-transition ... > --}}
        ...
        <div class="flex justify-between items-center border-b p-5">
            <h3 class="text-xl font-semibold text-gray-800">Tambah Data Gaji Baru</h3>
            ...
            <div class="p-5 space-y-6 max-h-[65vh] overflow-y-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="number" step="any" id="gaji_pokok" name="gaji_pokok" value="{{ old('gaji_pokok') }}" placeholder="e.g., 5000000" required
                               class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 py-2 px-3">
                    </div>
                    <div>
                        <label for="tunjangan" class="block mb-2 text-sm font-medium text-gray-700">Tunjangan</label>
                        <input type="number" step="any" id="tunjangan" name="tunjangan" value="{{ old('tunjangan', 0) }}" placeholder="e.g., 500000" 
                               class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 py-2 px-3">
                    </div>
                    <div>
                        <label for="potongan" class="block mb-2 text-sm font-medium text-gray-700">Potongan</label>
                        <input type="number" step="any" id="potongan" name="potongan" value="{{ old('potongan', 0) }}" placeholder="e.g., 150000" 
                               class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 py-2 px-3">
                    </div>
                </div>
            </div>
